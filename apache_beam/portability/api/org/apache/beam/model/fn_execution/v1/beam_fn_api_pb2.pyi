...
class RemoteGrpcPort(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["api_service_descriptor", b"api_service_descriptor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["api_service_descriptor", b"api_service_descriptor", "coder_id", b"coder_id"]) -> None: ...
...
class GetProcessBundleDescriptorRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["process_bundle_descriptor_id", b"process_bundle_descriptor_id"]) -> None: ...
...
class InstructionResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "finalize_bundle", b"finalize_bundle", "harness_monitoring_infos", b"harness_monitoring_infos", "instruction_id", b"instruction_id", "monitoring_infos", b"monitoring_infos", "process_bundle", b"process_bundle", "process_bundle_progress", b"process_bundle_progress", "process_bundle_split", b"process_bundle_split", "register", b"register", "response", b"response", "sample_data", b"sample_data"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["process_bundle", "process_bundle_progress", "process_bundle_split", "finalize_bundle", "monitoring_infos", "harness_monitoring_infos", "sample_data", "register"] | None: ...
...
class SampleDataRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["pcollection_ids", b"pcollection_ids"]) -> None: ...
...
class SampleDataResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["element_samples", b"element_samples"]) -> None: ...
...
class HarnessMonitoringInfosResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["monitoring_data", b"monitoring_data"]) -> None: ...
...
class RegisterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["process_bundle_descriptor", b"process_bundle_descriptor"]) -> None: ...
...
class ProcessBundleDescriptor(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["state_api_service_descriptor", b"state_api_service_descriptor", "timer_api_service_descriptor", b"timer_api_service_descriptor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["coders", b"coders", "environments", b"environments", "id", b"id", "pcollections", b"pcollections", "state_api_service_descriptor", b"state_api_service_descriptor", "timer_api_service_descriptor", b"timer_api_service_descriptor", "transforms", b"transforms", "windowing_strategies", b"windowing_strategies"]) -> None: ...
...
class BundleApplication(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["element", b"element", "input_id", b"input_id", "is_bounded", b"is_bounded", "output_watermarks", b"output_watermarks", "transform_id", b"transform_id"]) -> None: ...
...
class DelayedBundleApplication(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["application", b"application", "requested_time_delay", b"requested_time_delay"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["application", b"application", "requested_time_delay", b"requested_time_delay"]) -> None: ...
...
class ProcessBundleRequest(google.protobuf.message.Message):
    ...
    class CacheToken(google.protobuf.message.Message):
        ...
        class SideInput(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["side_input_id", b"side_input_id", "transform_id", b"transform_id"]) -> None: ...
        ...
        def HasField(self, field_name: typing.Literal["side_input", b"side_input", "type", b"type", "user_state", b"user_state"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["side_input", b"side_input", "token", b"token", "type", b"type", "user_state", b"user_state"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["user_state", "side_input"] | None: ...
    ...
    def HasField(self, field_name: typing.Literal["elements", b"elements"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cache_tokens", b"cache_tokens", "elements", b"elements", "process_bundle_descriptor_id", b"process_bundle_descriptor_id"]) -> None: ...
...
class ProcessBundleResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elements", b"elements"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elements", b"elements", "monitoring_data", b"monitoring_data", "monitoring_infos", b"monitoring_infos", "requires_finalization", b"requires_finalization", "residual_roots", b"residual_roots"]) -> None: ...
...
class ProcessBundleProgressRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["instruction_id", b"instruction_id"]) -> None: ...
...
class MonitoringInfosMetadataRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["monitoring_info_id", b"monitoring_info_id"]) -> None: ...
...
class ProcessBundleProgressResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["monitoring_data", b"monitoring_data", "monitoring_infos", b"monitoring_infos"]) -> None: ...
...
class MonitoringInfosMetadataResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["monitoring_info", b"monitoring_info"]) -> None: ...
...
class ProcessBundleSplitRequest(google.protobuf.message.Message):
    ...
    class DesiredSplit(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["allowed_split_points", b"allowed_split_points", "estimated_input_elements", b"estimated_input_elements", "fraction_of_remainder", b"fraction_of_remainder"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["desired_splits", b"desired_splits", "instruction_id", b"instruction_id"]) -> None: ...
...
class ProcessBundleSplitResponse(google.protobuf.message.Message):
    ...
    class ChannelSplit(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["first_residual_element", b"first_residual_element", "last_primary_element", b"last_primary_element", "transform_id", b"transform_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["channel_splits", b"channel_splits", "primary_roots", b"primary_roots", "residual_roots", b"residual_roots"]) -> None: ...
...
class Elements(google.protobuf.message.Message):
    ...
    class Data(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["data", b"data", "instruction_id", b"instruction_id", "is_last", b"is_last", "transform_id", b"transform_id"]) -> None: ...
    ...
    class Timers(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["instruction_id", b"instruction_id", "is_last", b"is_last", "timer_family_id", b"timer_family_id", "timers", b"timers", "transform_id", b"transform_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "timers", b"timers"]) -> None: ...
...
class StateRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["append", b"append", "clear", b"clear", "get", b"get", "request", b"request", "state_key", b"state_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["append", b"append", "clear", b"clear", "get", b"get", "id", b"id", "instruction_id", b"instruction_id", "request", b"request", "state_key", b"state_key"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["get", "append", "clear"] | None: ...
...
class StateResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["append", b"append", "clear", b"clear", "get", b"get", "response", b"response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["append", b"append", "clear", b"clear", "error", b"error", "get", b"get", "id", b"id", "response", b"response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["get", "append", "clear"] | None: ...
...
class StateKey(google.protobuf.message.Message):
    ...
    class IterableSideInput(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["side_input_id", b"side_input_id", "transform_id", b"transform_id", "window", b"window"]) -> None: ...
    ...
    class MultimapSideInput(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["key", b"key", "side_input_id", b"side_input_id", "transform_id", b"transform_id", "window", b"window"]) -> None: ...
    ...
    class BagUserState(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["key", b"key", "transform_id", b"transform_id", "user_state_id", b"user_state_id", "window", b"window"]) -> None: ...
    ...
    class MultimapUserState(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["key", b"key", "map_key", b"map_key", "transform_id", b"transform_id", "user_state_id", b"user_state_id", "window", b"window"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["bag_user_state", b"bag_user_state", "iterable_side_input", b"iterable_side_input", "multimap_keys_side_input", b"multimap_keys_side_input", "multimap_keys_user_state", b"multimap_keys_user_state", "multimap_side_input", b"multimap_side_input", "multimap_user_state", b"multimap_user_state", "runner", b"runner", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["bag_user_state", b"bag_user_state", "iterable_side_input", b"iterable_side_input", "multimap_keys_side_input", b"multimap_keys_side_input", "multimap_keys_user_state", b"multimap_keys_user_state", "multimap_side_input", b"multimap_side_input", "multimap_user_state", b"multimap_user_state", "runner", b"runner", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["runner", "multimap_side_input", "bag_user_state", "iterable_side_input", "multimap_keys_side_input", "multimap_keys_user_state", "multimap_user_state"] | None: ...
...
class StateGetResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["continuation_token", b"continuation_token", "data", b"data"]) -> None: ...
...
class LogEntry(google.protobuf.message.Message):
    ...
    class List(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["log_entries", b"log_entries"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["custom_data", b"custom_data", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["custom_data", b"custom_data", "instruction_id", b"instruction_id", "log_location", b"log_location", "message", b"message", "severity", b"severity", "thread", b"thread", "timestamp", b"timestamp", "trace", b"trace", "transform_id", b"transform_id"]) -> None: ...
...
class StartWorkerRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["artifact_endpoint", b"artifact_endpoint", "control_endpoint", b"control_endpoint", "logging_endpoint", b"logging_endpoint", "provision_endpoint", b"provision_endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["artifact_endpoint", b"artifact_endpoint", "control_endpoint", b"control_endpoint", "logging_endpoint", b"logging_endpoint", "params", b"params", "provision_endpoint", b"provision_endpoint", "worker_id", b"worker_id"]) -> None: ...
...
class WorkerStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "id", b"id", "status_info", b"status_info"]) -> None: ...
