...
class ResolveArtifactsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifacts", b"artifacts", "preferred_urns", b"preferred_urns"]) -> None: ...
...
class ResolveArtifactsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["replacements", b"replacements"]) -> None: ...
...
class ArtifactRequestWrapper(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["get_artifact", b"get_artifact", "request", b"request", "resolve_artifact", b"resolve_artifact"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["get_artifact", b"get_artifact", "request", b"request", "resolve_artifact", b"resolve_artifact"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["resolve_artifact", "get_artifact"] | None: ...
...
class ArtifactResponseWrapper(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["get_artifact_response", b"get_artifact_response", "resolve_artifact_response", b"resolve_artifact_response", "response", b"response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["get_artifact_response", b"get_artifact_response", "is_last", b"is_last", "resolve_artifact_response", b"resolve_artifact_response", "response", b"response", "staging_token", b"staging_token"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["resolve_artifact_response", "get_artifact_response"] | None: ...
...
class ArtifactMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "permissions", b"permissions", "sha256", b"sha256"]) -> None: ...
...
class ProxyManifest(google.protobuf.message.Message):
    ...
    class Location(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["name", b"name", "uri", b"uri"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["location", b"location", "manifest", b"manifest"]) -> None: ...
...
class GetManifestRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["retrieval_token", b"retrieval_token"]) -> None: ...
...
class GetManifestResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["manifest", b"manifest"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["manifest", b"manifest"]) -> None: ...
...
class LegacyGetArtifactRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "retrieval_token", b"retrieval_token"]) -> None: ...
...
class PutArtifactMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["metadata", b"metadata", "staging_session_token", b"staging_session_token"]) -> None: ...
...
class PutArtifactRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["content", b"content", "data", b"data", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["content", b"content", "data", b"data", "metadata", b"metadata"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["content", b"content"]) -> typing.Literal["metadata", "data"] | None: ...
...
class CommitManifestRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["manifest", b"manifest"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["manifest", b"manifest", "staging_session_token", b"staging_session_token"]) -> None: ...
