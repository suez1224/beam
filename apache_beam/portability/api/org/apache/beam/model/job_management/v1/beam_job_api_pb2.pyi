...
class PrepareJobRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["pipeline", b"pipeline", "pipeline_options", b"pipeline_options"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["job_name", b"job_name", "pipeline", b"pipeline", "pipeline_options", b"pipeline_options"]) -> None: ...
...
class PrepareJobResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["artifact_staging_endpoint", b"artifact_staging_endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["artifact_staging_endpoint", b"artifact_staging_endpoint", "preparation_id", b"preparation_id", "staging_session_token", b"staging_session_token"]) -> None: ...
...
class RunJobRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["preparation_id", b"preparation_id", "retrieval_token", b"retrieval_token"]) -> None: ...
...
class JobInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["pipeline_options", b"pipeline_options"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["job_id", b"job_id", "job_name", b"job_name", "pipeline_options", b"pipeline_options", "state", b"state"]) -> None: ...
...
class GetJobsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["job_info", b"job_info"]) -> None: ...
...
class JobMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["importance", b"importance", "message_id", b"message_id", "message_text", b"message_text", "time", b"time"]) -> None: ...
...
class JobMessagesResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["message_response", b"message_response", "response", b"response", "state_response", b"state_response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["message_response", b"message_response", "response", b"response", "state_response", b"state_response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["message_response", "state_response"] | None: ...
...
class MetricResults(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["attempted", b"attempted", "committed", b"committed"]) -> None: ...
...
class PipelineOptionDescriptor(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["default_value", b"default_value", "description", b"description", "group", b"group", "name", b"name", "type", b"type"]) -> None: ...
