...
class Schema(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["encoding_positions_set", b"encoding_positions_set", "fields", b"fields", "id", b"id", "options", b"options"]) -> None: ...
...
class Field(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "encoding_position", b"encoding_position", "id", b"id", "name", b"name", "options", b"options", "type", b"type"]) -> None: ...
...
class FieldType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["array_type", b"array_type", "atomic_type", b"atomic_type", "iterable_type", b"iterable_type", "logical_type", b"logical_type", "map_type", b"map_type", "row_type", b"row_type", "type_info", b"type_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["array_type", b"array_type", "atomic_type", b"atomic_type", "iterable_type", b"iterable_type", "logical_type", b"logical_type", "map_type", b"map_type", "nullable", b"nullable", "row_type", b"row_type", "type_info", b"type_info"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type_info", b"type_info"]) -> typing.Literal["atomic_type", "array_type", "iterable_type", "map_type", "row_type", "logical_type"] | None: ...
...
class ArrayType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["element_type", b"element_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["element_type", b"element_type"]) -> None: ...
...
class MapType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["key_type", b"key_type", "value_type", b"value_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["key_type", b"key_type", "value_type", b"value_type"]) -> None: ...
...
class LogicalType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["argument", b"argument", "argument_type", b"argument_type", "representation", b"representation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["argument", b"argument", "argument_type", b"argument_type", "payload", b"payload", "representation", b"representation", "urn", b"urn"]) -> None: ...
...
class FieldValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["array_value", b"array_value", "atomic_value", b"atomic_value", "field_value", b"field_value", "iterable_value", b"iterable_value", "logical_type_value", b"logical_type_value", "map_value", b"map_value", "row_value", b"row_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["array_value", b"array_value", "atomic_value", b"atomic_value", "field_value", b"field_value", "iterable_value", b"iterable_value", "logical_type_value", b"logical_type_value", "map_value", b"map_value", "row_value", b"row_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["field_value", b"field_value"]) -> typing.Literal["atomic_value", "array_value", "iterable_value", "map_value", "row_value", "logical_type_value"] | None: ...
...
class AtomicTypeValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["boolean", b"boolean", "byte", b"byte", "bytes", b"bytes", "double", b"double", "float", b"float", "int16", b"int16", "int32", b"int32", "int64", b"int64", "string", b"string", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["boolean", b"boolean", "byte", b"byte", "bytes", b"bytes", "double", b"double", "float", b"float", "int16", b"int16", "int32", b"int32", "int64", b"int64", "string", b"string", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["byte", "int16", "int32", "int64", "float", "double", "string", "boolean", "bytes"] | None: ...
