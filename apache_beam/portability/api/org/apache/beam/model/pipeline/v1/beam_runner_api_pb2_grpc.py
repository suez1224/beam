...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in org/apache/beam/model/pipeline/v1/beam_runner_api_pb2_grpc.py depends on'
...
def add_TestStreamServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('org.apache.beam.model.pipeline.v1.TestStreamService', rpc_method_handlers)
