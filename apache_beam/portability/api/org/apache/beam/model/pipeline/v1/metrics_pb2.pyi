...
class MonitoringInfoSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["annotations", b"annotations", "required_labels", b"required_labels", "type", b"type", "urn", b"urn"]) -> None: ...
...
class MonitoringInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["labels", b"labels", "payload", b"payload", "start_time", b"start_time", "type", b"type", "urn", b"urn"]) -> None: ...
