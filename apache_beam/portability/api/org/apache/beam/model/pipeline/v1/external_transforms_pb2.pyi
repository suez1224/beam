...
class ExternalConfigurationPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["payload", b"payload", "schema", b"schema"]) -> None: ...
...
class JavaClassLookupPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["constructor_schema", b"constructor_schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["builder_methods", b"builder_methods", "class_name", b"class_name", "constructor_method", b"constructor_method", "constructor_payload", b"constructor_payload", "constructor_schema", b"constructor_schema"]) -> None: ...
...
class BuilderMethod(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["schema", b"schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "payload", b"payload", "schema", b"schema"]) -> None: ...
...
class SchemaTransformPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["configuration_schema", b"configuration_schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["configuration_row", b"configuration_row", "configuration_schema", b"configuration_schema", "identifier", b"identifier"]) -> None: ...
