...
class Components(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["coders", b"coders", "environments", b"environments", "pcollections", b"pcollections", "transforms", b"transforms", "windowing_strategies", b"windowing_strategies"]) -> None: ...
...
class Pipeline(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["components", b"components"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["components", b"components", "display_data", b"display_data", "requirements", b"requirements", "root_transform_ids", b"root_transform_ids"]) -> None: ...
...
class PTransform(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["annotations", b"annotations", "display_data", b"display_data", "environment_id", b"environment_id", "inputs", b"inputs", "outputs", b"outputs", "spec", b"spec", "subtransforms", b"subtransforms", "unique_name", b"unique_name"]) -> None: ...
...
class PCollection(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["coder_id", b"coder_id", "display_data", b"display_data", "is_bounded", b"is_bounded", "unique_name", b"unique_name", "windowing_strategy_id", b"windowing_strategy_id"]) -> None: ...
...
class StateSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["bag_spec", b"bag_spec", "combining_spec", b"combining_spec", "map_spec", b"map_spec", "multimap_spec", b"multimap_spec", "ordered_list_spec", b"ordered_list_spec", "protocol", b"protocol", "read_modify_write_spec", b"read_modify_write_spec", "set_spec", b"set_spec", "spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["bag_spec", b"bag_spec", "combining_spec", b"combining_spec", "map_spec", b"map_spec", "multimap_spec", b"multimap_spec", "ordered_list_spec", b"ordered_list_spec", "protocol", b"protocol", "read_modify_write_spec", b"read_modify_write_spec", "set_spec", b"set_spec", "spec", b"spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["spec", b"spec"]) -> typing.Literal["read_modify_write_spec", "bag_spec", "combining_spec", "map_spec", "set_spec", "ordered_list_spec", "multimap_spec"] | None: ...
...
class ReadModifyWriteStateSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["coder_id", b"coder_id"]) -> None: ...
...
class BagStateSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["element_coder_id", b"element_coder_id"]) -> None: ...
...
class CombiningStateSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["combine_fn", b"combine_fn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["accumulator_coder_id", b"accumulator_coder_id", "combine_fn", b"combine_fn"]) -> None: ...
...
class MapStateSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["key_coder_id", b"key_coder_id", "value_coder_id", b"value_coder_id"]) -> None: ...
...
class TimerFamilySpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["time_domain", b"time_domain", "timer_family_coder_id", b"timer_family_coder_id"]) -> None: ...
...
class ReadPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["is_bounded", b"is_bounded", "source", b"source"]) -> None: ...
...
class WindowIntoPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["window_fn", b"window_fn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["window_fn", b"window_fn"]) -> None: ...
...
class TestStreamPayload(google.protobuf.message.Message):
    ...
    class Event(google.protobuf.message.Message):
        ...
        class AdvanceWatermark(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["new_watermark", b"new_watermark", "tag", b"tag"]) -> None: ...
        ...
        class AdvanceProcessingTime(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["advance_duration", b"advance_duration"]) -> None: ...
        ...
        class AddElements(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["elements", b"elements", "tag", b"tag"]) -> None: ...
        ...
        def HasField(self, field_name: typing.Literal["element_event", b"element_event", "event", b"event", "processing_time_event", b"processing_time_event", "watermark_event", b"watermark_event"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["element_event", b"element_event", "event", b"event", "processing_time_event", b"processing_time_event", "watermark_event", b"watermark_event"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["event", b"event"]) -> typing.Literal["watermark_event", "processing_time_event", "element_event"] | None: ...
    ...
    class TimestampedElement(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["encoded_element", b"encoded_element", "timestamp", b"timestamp"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["endpoint", b"endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["coder_id", b"coder_id", "endpoint", b"endpoint", "events", b"events"]) -> None: ...
...
class EventsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["output_ids", b"output_ids"]) -> None: ...
...
class WriteFilesPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["format_function", b"format_function", "sink", b"sink"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["format_function", b"format_function", "runner_determined_sharding", b"runner_determined_sharding", "side_inputs", b"side_inputs", "sink", b"sink", "windowed_writes", b"windowed_writes"]) -> None: ...
...
class PubSubWritePayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["id_attribute", b"id_attribute", "timestamp_attribute", b"timestamp_attribute", "topic", b"topic", "topic_runtime_overridden", b"topic_runtime_overridden"]) -> None: ...
...
class GroupIntoBatchesPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["batch_size", b"batch_size", "batch_size_bytes", b"batch_size_bytes", "max_buffering_duration_millis", b"max_buffering_duration_millis"]) -> None: ...
...
class Coder(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["component_coder_ids", b"component_coder_ids", "spec", b"spec"]) -> None: ...
...
class Trigger(google.protobuf.message.Message):
    ...
    class AfterAll(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["subtriggers", b"subtriggers"]) -> None: ...
    ...
    class AfterEndOfWindow(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["early_firings", b"early_firings", "late_firings", b"late_firings"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["early_firings", b"early_firings", "late_firings", b"late_firings"]) -> None: ...
    ...
    class AfterProcessingTime(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["timestamp_transforms", b"timestamp_transforms"]) -> None: ...
    ...
    class ElementCount(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["element_count", b"element_count"]) -> None: ...
    ...
    class OrFinally(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["finally", b"finally", "main", b"main"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["finally", b"finally", "main", b"main"]) -> None: ...
    ...
    class Repeat(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["subtrigger", b"subtrigger"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["subtrigger", b"subtrigger"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["after_all", b"after_all", "after_any", b"after_any", "after_each", b"after_each", "after_end_of_window", b"after_end_of_window", "after_processing_time", b"after_processing_time", "after_synchronized_processing_time", b"after_synchronized_processing_time", "always", b"always", "default", b"default", "element_count", b"element_count", "never", b"never", "or_finally", b"or_finally", "repeat", b"repeat", "trigger", b"trigger"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["after_all", b"after_all", "after_any", b"after_any", "after_each", b"after_each", "after_end_of_window", b"after_end_of_window", "after_processing_time", b"after_processing_time", "after_synchronized_processing_time", b"after_synchronized_processing_time", "always", b"always", "default", b"default", "element_count", b"element_count", "never", b"never", "or_finally", b"or_finally", "repeat", b"repeat", "trigger", b"trigger"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["trigger", b"trigger"]) -> typing.Literal["after_all", "after_any", "after_each", "after_end_of_window", "after_processing_time", "after_synchronized_processing_time", "always", "default", "element_count", "never", "or_finally", "repeat"] | None: ...
...
class TimestampTransform(google.protobuf.message.Message):
    ...
    class Delay(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["delay_millis", b"delay_millis"]) -> None: ...
    ...
    class AlignTo(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["offset", b"offset", "period", b"period"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["align_to", b"align_to", "delay", b"delay", "timestamp_transform", b"timestamp_transform"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["align_to", b"align_to", "delay", b"delay", "timestamp_transform", b"timestamp_transform"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["timestamp_transform", b"timestamp_transform"]) -> typing.Literal["delay", "align_to"] | None: ...
...
class SideInput(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["access_pattern", b"access_pattern", "view_fn", b"view_fn", "window_mapping_fn", b"window_mapping_fn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["access_pattern", b"access_pattern", "view_fn", b"view_fn", "window_mapping_fn", b"window_mapping_fn"]) -> None: ...
...
class ArtifactFilePayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["path", b"path", "sha256", b"sha256"]) -> None: ...
...
class ArtifactUrlPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["sha256", b"sha256", "url", b"url"]) -> None: ...
...
class PyPIPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifact_id", b"artifact_id", "version", b"version"]) -> None: ...
...
class MavenPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifact", b"artifact", "repository_url", b"repository_url"]) -> None: ...
...
class DeferredArtifactPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "key", b"key"]) -> None: ...
...
class ArtifactStagingToRolePayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["staged_name", b"staged_name"]) -> None: ...
...
class ArtifactInformation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["role_payload", b"role_payload", "role_urn", b"role_urn", "type_payload", b"type_payload", "type_urn", b"type_urn"]) -> None: ...
...
class Environment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["capabilities", b"capabilities", "dependencies", b"dependencies", "display_data", b"display_data", "payload", b"payload", "resource_hints", b"resource_hints", "urn", b"urn"]) -> None: ...
...
class DockerPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["container_image", b"container_image"]) -> None: ...
...
class ProcessPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["arch", b"arch", "command", b"command", "env", b"env", "os", b"os"]) -> None: ...
...
class ExternalPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["endpoint", b"endpoint"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["endpoint", b"endpoint", "params", b"params"]) -> None: ...
...
class FunctionSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["payload", b"payload", "urn", b"urn"]) -> None: ...
...
class LabelledPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["bool_value", b"bool_value", "double_value", b"double_value", "int_value", b"int_value", "key", b"key", "label", b"label", "namespace", b"namespace", "string_value", b"string_value", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["string_value", "bool_value", "double_value", "int_value"] | None: ...
...
class MessageWithComponents(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["coder", b"coder", "combine_payload", b"combine_payload", "components", b"components", "function_spec", b"function_spec", "par_do_payload", b"par_do_payload", "pcollection", b"pcollection", "ptransform", b"ptransform", "read_payload", b"read_payload", "root", b"root", "side_input", b"side_input", "window_into_payload", b"window_into_payload", "windowing_strategy", b"windowing_strategy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["coder", b"coder", "combine_payload", b"combine_payload", "components", b"components", "function_spec", b"function_spec", "par_do_payload", b"par_do_payload", "pcollection", b"pcollection", "ptransform", b"ptransform", "read_payload", b"read_payload", "root", b"root", "side_input", b"side_input", "window_into_payload", b"window_into_payload", "windowing_strategy", b"windowing_strategy"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["root", b"root"]) -> typing.Literal["coder", "combine_payload", "function_spec", "par_do_payload", "ptransform", "pcollection", "read_payload", "side_input", "window_into_payload", "windowing_strategy"] | None: ...
...
class ExecutableStagePayload(google.protobuf.message.Message):
    ...
    class SideInputId(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["local_name", b"local_name", "transform_id", b"transform_id"]) -> None: ...
    ...
    class WireCoderSetting(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["input_or_output_id", b"input_or_output_id", "target", b"target", "timer", b"timer"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["input_or_output_id", b"input_or_output_id", "payload", b"payload", "target", b"target", "timer", b"timer", "urn", b"urn"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["target", b"target"]) -> typing.Literal["input_or_output_id", "timer"] | None: ...
    ...
    def HasField(self, field_name: typing.Literal["components", b"components", "environment", b"environment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["components", b"components", "environment", b"environment", "input", b"input", "outputs", b"outputs", "side_inputs", b"side_inputs", "timerFamilies", b"timerFamilies", "timers", b"timers", "transforms", b"transforms", "user_states", b"user_states", "wire_coder_settings", b"wire_coder_settings"]) -> None: ...
