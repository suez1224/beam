...
class ExpansionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["components", b"components", "transform", b"transform"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["components", b"components", "namespace", b"namespace", "output_coder_requests", b"output_coder_requests", "transform", b"transform"]) -> None: ...
...
class ExpansionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["components", b"components", "transform", b"transform"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["components", b"components", "error", b"error", "requirements", b"requirements", "transform", b"transform"]) -> None: ...
...
class SchemaTransformConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["config_schema", b"config_schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["config_schema", b"config_schema", "input_pcollection_names", b"input_pcollection_names", "output_pcollection_names", b"output_pcollection_names"]) -> None: ...
...
class DiscoverSchemaTransformResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "schema_transform_configs", b"schema_transform_configs"]) -> None: ...
