...
class FixedWindowsPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["offset", b"offset", "size", b"size"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["offset", b"offset", "size", b"size"]) -> None: ...
...
class SlidingWindowsPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["offset", b"offset", "period", b"period", "size", b"size"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["offset", b"offset", "period", b"period", "size", b"size"]) -> None: ...
...
class SessionWindowsPayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["gap_size", b"gap_size"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["gap_size", b"gap_size"]) -> None: ...
