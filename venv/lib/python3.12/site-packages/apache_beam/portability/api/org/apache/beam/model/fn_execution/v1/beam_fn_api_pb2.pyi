...
class SampledElement(google.protobuf.message.Message):
    ...
    class Exception(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["error", b"error", "instruction_id", b"instruction_id", "transform_id", b"transform_id"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["exception", b"exception", "sample_timestamp", b"sample_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["element", b"element", "exception", b"exception", "sample_timestamp", b"sample_timestamp"]) -> None: ...
...
class ProcessBundleProgressResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_consuming_received_data", b"_consuming_received_data", "consuming_received_data", b"consuming_received_data"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_consuming_received_data", b"_consuming_received_data", "consuming_received_data", b"consuming_received_data", "monitoring_data", b"monitoring_data", "monitoring_infos", b"monitoring_infos"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_consuming_received_data", b"_consuming_received_data"]) -> typing.Literal["consuming_received_data"] | None: ...
...
class StateKey(google.protobuf.message.Message):
    ...
    class OrderedListUserState(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["key", b"key", "range", b"range", "transform_id", b"transform_id", "user_state_id", b"user_state_id", "window", b"window"]) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["runner", "multimap_side_input", "bag_user_state", "iterable_side_input", "multimap_keys_side_input", "multimap_keys_values_side_input", "multimap_keys_user_state", "multimap_user_state", "ordered_list_user_state"] | None: ...
