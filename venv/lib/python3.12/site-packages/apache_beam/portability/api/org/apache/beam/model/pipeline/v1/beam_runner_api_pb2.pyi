...
class WriteFilesPayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["auto_sharded", b"auto_sharded", "format_function", b"format_function", "runner_determined_sharding", b"runner_determined_sharding", "side_inputs", b"side_inputs", "sink", b"sink", "windowed_writes", b"windowed_writes"]) -> None: ...
...
class RedistributePayload(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["allow_duplicates", b"allow_duplicates"]) -> None: ...
