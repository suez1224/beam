...
class ExpansionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["components", b"components", "pipeline_options", b"pipeline_options", "transform", b"transform"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["components", b"components", "namespace", b"namespace", "output_coder_requests", b"output_coder_requests", "pipeline_options", b"pipeline_options", "requirements", b"requirements", "transform", b"transform"]) -> None: ...
...
class SchemaTransformConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["config_schema", b"config_schema", "description", b"description", "input_pcollection_names", b"input_pcollection_names", "output_pcollection_names", b"output_pcollection_names"]) -> None: ...
